...
Vancouver, BC, Canada • +1 (778) 998-1236 • hs3732065@gmail.com<br>
LinkedIn: https://linkedin.com/in/harpreet-singh-4523661a0 • GitHub: https://github.com/harpreeto6

## Education
**University of British Columbia (UBC)** (BASc, Computer Engineering, Vancouver, BC)<br>
Sept 2024 to Dec 2027 (expected)

## Projects
**Sensum: Wellbeing + Productivity App (Monorepo)** (Personal Project)<br>
Next.js • TypeScript • Tailwind • Java 17 • Spring Boot • PostgreSQL • MV3 Browser Extension • JWT (HttpOnly)
- Built a 3-part monorepo (Next.js web app + Spring Boot API + MV3 browser extension) to deliver wellbeing nudges and offline “quests” (2 to 10 minutes, 6 categories).
...
**Fitness Tracker: Desktop Nutrition Tracker** (Personal Project)<br>
Java • Swing • JSON
...
**Canvas Assistant: AI Chatbot** (Hackathon)<br>
...
**Data Science: Player Engagement Analysis** (Academic)<br>
...
**Math Tutor (Self-Employed)** (Jan 2025 to Present) (Surrey, BC)
...
- Backend: Spring Boot, REST APIs, Auth (JWT), PostgreSQL
